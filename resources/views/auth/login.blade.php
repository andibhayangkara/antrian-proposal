    ...
    <body class="teal">
        ...
        <div id="login-page" class="row">
                ...
                <form class="login-form" action="{{ route('post_login') }}" method="post" onsubmit="return load()">
                    ...
                    <div class="row">
                        <div class="input-field col s12 center">
                            <p class="center login-form-text" style="font-size:23px;margin-top:5px">Antrian UIM</p>
                            <p class="center login-form-text" style="letter-spacing:1px">Masukkan Username dan Password</p>
                        </div>
                    </div>
            ...
            <div class="row center-align white-text" style="margin-bottom:0">
                <span>Powered by <a href="http://www.justlabtech.com" target="_blank" style="color:#ccc">FT UIM</a></span>
            </div>
        </div>
