            ...
            <div class="col s12 m6">
                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <div class="divider" style="margin:10px 0 10px 0"></div>
                        @foreach($departments as $department)
                            <a href="{{route('call.reset', $department->id)}}" class="btn waves-effect waves-light" style="margin-bottom:10px;margin-right:5px;text-transform:none">{{ $department->name }}</a>
                            <!-- <span class="btn waves-effect waves-light frmsubmit" method="DELETE" style="margin-bottom:10px;margin-right:5px;text-transform:none">{{ $department->name }}</span> -->
                        @endforeach
                    </div>
                </div>
            </div>
