    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col s12 m6">
                ...
                <div class="card">
                    <div class="card-content">
                        <span class="card-title" style="line-height:0;font-size:22px">Reset Antrian</span>
                        <div class="divider" style="margin:10px 0 10px 0"></div>
                        <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            <a href="<?php echo e(route('call.reset', $department->id)); ?>" class="btn waves-effect waves-light" style="margin-bottom:10px;margin-right:5px;text-transform:none"><?php echo e($department->name); ?></a>
                            <!-- <span class="btn waves-effect waves-light frmsubmit" method="DELETE" style="margin-bottom:10px;margin-right:5px;text-transform:none"><?php echo e($department->name); ?></span> -->
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                    </div>
                </div>
            </div>
