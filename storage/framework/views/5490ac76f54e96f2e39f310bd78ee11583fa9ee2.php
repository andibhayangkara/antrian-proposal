            ...
            <div class="navbar-fixed">
                <nav class="navbar-color">
                    <div class="nav-wrapper">
                        <ul class="left">
                            <!-- <li><h1 class="logo-wrapper"><a href="<?php echo e(route('dashboard')); ?>" class="brand-logo darken-1"><img src="<?php echo e(asset('assets/images/jltoken-logo.png')); ?>" alt="materialize logo"></a><span class="logo-text">Antrianen</span></h1></li> -->
