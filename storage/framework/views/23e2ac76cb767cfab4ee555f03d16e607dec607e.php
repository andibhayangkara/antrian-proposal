...
<html>
    <head>
        ...
        <title><?php echo $__env->yieldContent('title'); ?> | Antrian</title>
    ...
    <body>
            ...
            <div class="navbar-fixed">
                <nav class="navbar-color">
                    <div class="nav-wrapper">
                        <ul class="left">
                            <!-- <li><h1 class="logo-wrapper"><a href="<?php echo e(route('dashboard')); ?>" class="brand-logo darken-1"><img src="<?php echo e(asset('assets/images/jltoken-logo.png')); ?>" alt="materialize logo"></a><span class="logo-text">JL Token</span></h1></li> -->
                            <li><h1><a href="<?php echo e(route('dashboard')); ?>" style="font-size:30px;font-weight:bold;margin-left:20  %;" class="darken-1">Antrian</a></h1></li>
                        </ul>
        ...
        <footer class="page-footer">
            <div class="footer-copyright">
                <div class="container">
                    <span>Powered by <a class="grey-text text-lighten-3" href="" target="_blank">FT UIM </a> All rights reserved.</span>
                    <span class="right"> <span class="grey-text text-lighten-3"></span> </span>
                </div>
            </div>
        </footer>
